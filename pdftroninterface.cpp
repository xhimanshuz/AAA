...
void PDFTronInterface::printInvoice(QList<QStringList> dataList, QStringList roDetail, QString fileName)
{
    std::string saveFile;
//    try {
        ...
        {
            replacer.AddString(QString("RONO_%0").arg(i).toStdString(), dataList.at(i).at(0).toStdString());
            replacer.AddString(QString("MEDIA_CENTRE_%0").arg(i).toStdString(), dataList.at(i).at(0).toStdString());
            replacer.AddString(QString("DATE_%0").arg(i).toStdString(), dataList.at(i).at(2).toStdString());
            replacer.AddString(QString("SIZE_DUR_%0").arg(i).toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("TOTAL_DUR_%0").arg(i).toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("HSN_%0").arg(i).toStdString(), dataList.at(0).at(0).toStdString());

            replacer.AddString(QString("RATE_%0").arg(i).toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("PREMIUM_%0").arg(i).toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("AMOUNT_%0").arg(i).toStdString(), dataList.at(0).at(0).toStdString());
        }
            replacer.AddString(QString("GROSS_AMOUNT").toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("DISCOUNT").toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("AMT_AFT_DIS").toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("CGST").toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("SGST").toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("IGST").toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("INVOICE_AMT").toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("CLIENT").toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("CLIENT_ADDRESS").toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("CLIENT_CITY").toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("INVOICE_DATE").toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("INVOICE_NO").toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("CAPTION").toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("STATE").toStdString(), dataList.at(0).at(0).toStdString());
            replacer.AddString(QString("CODE").toStdString(), dataList.at(0).at(0).toStdString());

            replacer.Process(page);
            saveFile = QString("../Data/RO/invoice_%0.pdf").arg(dataList.at(0).at(0)).toStdString();
            doc.Save(saveFile, SDFDoc::e_remove_unused, 0);
            qDebug() << "Done. Result saved in "<< saveFile.c_str();
            showPdf(saveFile.c_str());
}
